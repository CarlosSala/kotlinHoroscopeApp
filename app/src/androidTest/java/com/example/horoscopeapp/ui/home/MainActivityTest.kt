...
import com.example.horoscopeapp.ui.detail.HoroscopeDetailActivity
...
class MainActivityTest {
    ...
    // is recommended to disable animations of the phone develop options
    @Test
    fun when_horoscope_is_selected_then_open_detail() {
        onView(withId(R.id.rv_fragment_horoscope))
            .perform(
